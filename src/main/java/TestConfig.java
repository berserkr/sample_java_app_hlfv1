...
//                    DEFAULT_CONFIG));
            ...
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.ca_location", "http://127.0.0.1:7054");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.peer_locations", "peer0.org1.example.com@grpc://127.0.0.1:7051");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.orderer_locations", "orderer.example.com@grpc://127.0.0.1:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.eventhub_locations", "peer0.org1.example.com@grpc://127.0.0.1:7053");

//            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.mspid", "Org1MSP");
//            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.domname", "org1.example.com");
//            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.ca_location", "http://127.0.0.1:7054");
//            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.peer_locations", "peer0.org1.example.com@grpc://127.0.0.1:7051, peer1.org1.example.com@grpc://127.0.0.1:8051");
//            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.orderer_locations", "orderer.example.com@grpc://127.0.0.1:7050");
//            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.eventhub_locations", "peer0.org1.example.com@grpc://127.0.0.1:7052,peer1.org1.example.com@grpc://127.0.0.1:8052");
...
//            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.ca_location", "http://127.0.0.1:8054");
//            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.peer_locations", "peer0.org2.example.com@grpc://127.0.0.1:9051,peer1.org2.example.com@grpc://127.0.0.1:10051");
//            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.orderer_locations", "orderer.example.com@grpc://127.0.0.1:7050");
//            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.eventhub_locations", "peer0.org2.example.com@grpc://127.0.0.1:9052, peer1.org2.example.com@grpc://127.0.0.1:10052");
