...
public class End2endIT {
    ...
    private static final String SDK_PATH = "C:\\Users\\lbath\\source\\repos\\fabric-sdk-java\\src\\test\\java\\org\\hyperledger\\fabric\\";
    private static final String SDK_FIXTURES_PATH = "C:\\Users\\lbath\\source\\repos\\fabric-sdk-java\\src\\test\\fixture\\sdkintegration\\";
...
//                                                    assertEquals(0, readList.getVersion().getTxNum());
                                                    out("a: %s, 1: %s, 0: %s", readList.getKey(),
...
//                                                    assertEquals(1, readList.getVersion().getBlockNum());
//                                                    assertEquals(0, readList.getVersion().getTxNum());
                                                    out("b: %s, 1: %s, 0: %s", readList.getKey(),
                                                            readList.getVersion().getBlockNum(),
                                                            readList.getVersion().getTxNum());
